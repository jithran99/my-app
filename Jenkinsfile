node{
   ...
   sh "docker login -u admin -p admin123 3.109.121.200:8083"
   sh "docker tag ranjithvk99/myweb:0.0.2 3.109.121.200:8083/ranj:1.0.0"
   sh 'docker push 3.109.121.200:8083/ranj:1.0.0'
   }
